...
test("availability and install paths are honest", () => {
  ...
  assert.match(
    html,
    /href="https:\/\/github\.com\/VocaHQ\/vocaphone\/releases\/tag\/android\/v0\.1\.1"/,
  );
  ...
  assert.ok(
    hero.includes("https://github.com/VocaHQ/vocaphone/releases/tag/android/v0.1.1"),
  ...
  const tagHrefAt = androidCard.indexOf(
    "https://github.com/VocaHQ/vocaphone/releases/tag/android/v0.1.1",
  );
