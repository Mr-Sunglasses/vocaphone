...
| Initial engine | `auto`: Handy, WhisperKit, MLX Audio, sherpa-onnx, faster-whisper, then `whisper.cpp` | Uses what is actually runnable while preserving an explicit WebUI choice |
