...
struct SetupView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("Set up Local Flow")
        ...
        .onReceive(
            ...
            // Switching into the Local Flow keyboard happens without the app
        ...
        Section {
            VStack(alignment: .leading, spacing: 8) {
                Text("Dictate into any app")
                    .font(.title3.bold())
                Text(
                    "Local Flow records on this iPhone and transcribes on a "
    ...
    @ViewBuilder private var keyboardStep: some View {
        ...
        if !status.isSatisfied(.keyboard) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                TextField("Tap here, then hold 🌐 and pick Local Flow", text: $keyboardProbeText)
                    .textInputAutocapitalization(.never)
                Text("Switching to Local Flow here ticks this step automatically.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
            }
            .padding(.leading, 32)
            ...
            if status.isReadyToDictate {
                ...
                Text(
                    "Still to do: "
                        ...
                        + ". Local Flow will remind you on the main screen."
                )
            }
        }
    }
