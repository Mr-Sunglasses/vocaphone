...
@main
struct LocalFlowWidgetBundle: WidgetBundle {
    var body: some Widget {
        LocalFlowRecordingActivity()
    }
}

struct LocalFlowRecordingActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: LocalFlowActivityAttributes.self) { context in
            HStack(spacing: 14) {
